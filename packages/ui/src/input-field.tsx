  ...
  return (
    <div className={className}>
      ...
      <input
        ...
        disabled={disabled}
        className={`ui:w-full ui:px-3 ui:py-2 ui:border ui:rounded-md ui:shadow-sm ui:placeholder-gray-400 focus:ui:outline-none focus:ui:ring-2 focus:ui:ring-indigo-500 focus:ui:border-indigo-500 ui:transition-colors ${
